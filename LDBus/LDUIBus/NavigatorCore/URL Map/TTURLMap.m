           ...
           pattern:(TTURLNavigatorPattern **)outPattern
{
    ...
    if (pattern) {
        ...
        if (pattern.targetClass == nil && pattern.targetObject == nil) {
            ...
            NSString *actQuery =
                theURL.query == nil ? @"" : [NSString stringWithFormat:@"?%@", theURL.query];
            NSString *actFragement =
                theURL.fragment == nil ? @"" : [NSString stringWithFormat:@"#%@", theURL.fragment];
            NSString *actWebURL = [NSString stringWithFormat:@"%@://%@%@%@%@", patternWebURL.scheme,
                                                             patternWebURL.host, patternWebURL.path,
                                                             actQuery, actFragement];
